...
/**
 * A {@link RuntimeAction} that uploads a {@code file} with an associated
 * {@code message} to a given Slack {@code channel}.
 * <p>
...
public class PostFileMessage extends RuntimeArtifactAction<SlackPlatform> {
	 ...
	 * <p>
	 * If this field is {@code null} the class should hold a valid {@code content}
	 * value.
	 */
	private File file;
	 ...
	 * <p>
	 * If this field is {@code null} the class should hold a valid {@code file}
	 * value.
	 */
	private String content;

	/**
	 * The initial comment associated to the file to upload to the given Slack
	 * {@code channel}.
	 */
	private String message;

	/**
	 * Constructs a new {@link PostFileMessage} with the provided
	 * {@code runtimePlatform}, {@code session}, {@code
	 * message}, {@code file}, and {@code channel}.
	 * <p>
	 * This constructor builds a {@link PostFileMessage} action that uploads the
	 * provided {@code file} to the given Slack {@code channel}. To upload a
	 * {@link String} as a file see
	 ...
	 * @throws IllegalArgumentException if the provided {@code message} or
	 *                                  {@code channel} is {@code null} or empty, or
	 *                                  if the provided {@code file} is {@code null}
	 *                                  or does not exist
	...
	public PostFileMessage(SlackPlatform runtimePlatform, XatkitSession session, String message, File file,
		...
		checkArgument(nonNull(file) && file.exists(),
				"Cannot construct a %s action with the provided file %s, " + "expected a non-null and existing file",
	 ...
	 * <p>
	 * This constructor builds a {@link PostFileMessage} action that uploads the
	 * provided {@code content} as a file to the given Slack {@code channel}. To
	 * upload an existing {@link File} see
	 ...
	 * @throws NullPointerException     if the provided {@code runtimePlatform} or
	 *                                  {@code session} is {@code null}
	 * @throws IllegalArgumentException if the provided {@code title},
	 *                                  {@code message}, {@code content}, or {@code
	...
	/**
	 * Uploads the provided {@code file} and post it with the associated
	 * {@code message} to the given {@code channel}.
	 * <p>
	 * This method relies on the containing {@link SlackPlatform}'s Slack bot API
	 * token to authenticate the bot and upload the {@code file} to the given
	 * {@code channel}.
	 *
	 * @return {@code null}
	 */
