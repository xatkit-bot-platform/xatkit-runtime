package fr.zelus.jarvis.plugins.discord.platform;
 ...
 * <ul>
 * <li>{@link fr.zelus.jarvis.plugins.discord.platform.action.Reply}: reply to a user input</li>
 * <li>{@link fr.zelus.jarvis.plugins.discord.platform.action.PostMessage}: post a message to a given Discord
 * channel</li>
 * </ul>
 * <p>
