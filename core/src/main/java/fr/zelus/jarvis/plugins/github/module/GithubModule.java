...
/**
 * A {@link JarvisModule} class that connects and interacts with the Github API.
 * <p>
 * This module manages a output connection to the Github API, and provides a set of
 * {@link fr.zelus.jarvis.core.JarvisAction}s to interact with the Github API:
 * <ul>
 *     <li>{@link fr.zelus.jarvis.plugins.github.module.action.OpenIssue}: open an issue on a given repository</li>
 * </ul>
 * <p>
 * This class is part of jarvis' core modules, and can be used in an orchestration model by importing the
 * <i>GithubModule</i> package.
 */
public class GithubModule extends JarvisModule {
     ...
     * <p>
     * The {@link GithubModule} can handle {@link Configuration} with username/password as well as oauth token. Note
     ...
     * {@link GithubModule} initialized with no credentials can still be used to construct Github-related
     * {@link fr.zelus.jarvis.io.EventProvider}s.
     */
    private Github githubClient;

    /**
     * Constructs a new {@link GithubModule} from the provided {@link JarvisCore} and {@link Configuration}.
     * <p>
     ...
     * be found the {@link GithubModule} is still initialized, but will not be able to access and manipulate the
     * Github API.
     * <p>
     * {@link GithubModule} initialized with no credentials can still be used to construct Github-related
     * {@link fr.zelus.jarvis.io.EventProvider}s, that will work as expected. Note that if the provided
     * {@link Configuration} defines credentials the constructed {@link GithubModule} will check that these
     ...
     * @throws JarvisException if the {@link GithubModule} does not define a valid {@link Github} client (i.e. if the
